...
import { FaUser, FaPhone, FaEnvelope, FaLock, FaEye, FaEyeSlash, FaLeaf, FaMapMarkerAlt,} from "react-icons/fa";
...
function Register() {
  ...
  return (
    <div className="login-page">
      ...
      <motion.div className="register-card" initial={{ opacity: 0, y: 70 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} >
        ...
        <form onSubmit={handleRegister}>
            ...
            <div className="input-box">
              <FaPhone className="input-icon" />
                <input type="tel" placeholder="Mobile Number" name="mobile" value={formData.mobile} onChange={handleChange} maxLength="10" required />
            </div>
            ...
            <div className="input-box">
              <FaLock className="input-icon" />
                ...
                <input type={showConfirm ? "text" : "password"} placeholder="Confirm Password" name="confirmPassword" value={formData.confirmPassword} onChange={handleChange} required />
